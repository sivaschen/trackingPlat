                    ...
                    <Col className="version" span={10}>                        
                        <div className="specifics">
                            ...
                            <Row className="bottom">
                                <Col className="batteryParam" span={24}>
                                    <Row className="batteryParamTop batteryRow">                            
                                            <Col span={8}><span><i className="sp"></i><i className="title">额定容量</i><br/><span className="data">{data.rated_capacity+" Ah"}</span></span></Col>
                                            <Col span={8}><span><i className="sp"></i><i className="title">累计放电容量</i><br/><span className="data">{data.discharge_capacity/10+" Ah"}</span></span></Col>
                            ...
                            series: [                            
                                {
                                    name: '电压',
                                    type: 'gauge',
                                    detail: {formatter: '{value} V', fontSize: 12, offsetCenter: [0, "70%"],color: '#ffffff'},
                            ...
                            series: [                            
                                {
                                    name: '电流',
                                    type: 'gauge',
                                    detail: {formatter: '{value} A',fontSize: 12, offsetCenter: [0, "70%"], color: '#ffffff'},
                            ...
                            series: [                            
                                {
                                    name: '容量',
                                    type: 'gauge',
                                    detail: {formatter: '{value} Ah',fontSize: 12, offsetCenter: [0, "70%"],color: '#ffffff'},
                            ...
                            series: [                            
                                {
                                    name: 'SOC',
                                    type: 'gauge',
                                    detail: {formatter: '{value} %',fontSize: 12, offsetCenter: [0, "70%"],color: '#ffffff'},
